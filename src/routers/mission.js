...
router.get('/missions', async (req, res) => {
    ...
    try {
        ...
        // .exec()
        .sort(sort)
        // await missions.populate('author').execPopulate()
        // console.log(missions.author.username)
        ...
        // for (mish in missions) {  
        //     await mish.populate('author').execPopulate();
        // }
...
router.patch('/missions/:id', auth, async (req, res) => {
    ...
    const allowedUpdates = ['missionName', 'avgCompletionTime', 'completedCount', 'missionDetails', 'badges', 'missionEndorsements', 'author']
